...
**CHECK THIS AGAIN.**
A manual inspection of the charts for agreement in which variables are
associated in the 240 second and 60 second data shows that, for both, the
majority are shared. There are 20 associations which are present in both. That
is 57% of the associations picked out in the 60 second data are also picked out
in the 240 second data and, 55%, going the other way. With the exception of the
<span style = "font-variant: small-caps;">trap</span> F2 - <span style =
"font-variant: small-caps;">fleece</span> F2 association, all of these are
associations between F1s.

...
``` {r animated-plot, fig.dim = c(10, 8), fig.cap = "Animated plot of effect of amplitude and articulation rate on vowel space as predicted by GAMM models."}
...
``` {r int-plot, fig.dim = c(10, 8), fig.cap = "Interactive plot of effect of amplitude and articulation rate on vowel space as predicted by GAMM models."}
...
This is, in general, quite similar to (Figure \@ref(fig:amp-mono)). This is good,
